...
export const GLOSSARY = {
  ...
  "Aimed Shot": "An Attack at −3 Aim where you choose the part hit instead of rolling the D12.",
  "Grit token": "The side behind gets them each round (1 at 2+ VP behind, 2 at 5+, 3 at 8+): a free face-down reaction that's Improved (Brace −3 Pen, Raise Shield −4, dodges on 3+, counter-attacks +2 Penetration), an upgrade to one already placed, or spent on an attack to reroll every missed to-hit die once.",
  "bounty": "While your side is behind on VP, every kill pays +2 VP extra.",
  ...
  "Raking Fire": "Keyword: can't wound a target's front arc; side +3 Penetration, rear +6. Flank or waste the shot.",
  "Armour Piercing": "Keyword: reroll every failed wound roll.",
  "Rend": "Keyword: each wound deals +1 Damage.",
  "Precision": "Keyword: Aimed Shots without the −3 Aim penalty.",
  "Shock": "Keyword: on a hit, the target's movement is halved next activation.",
  "Incendiary": "Keyword: on a hit, the target gains 1 heat.",
  "Impale": "Keyword: on a hit roll a D12; 8+ pins the target until your next activation.",
  "Bulwark": "Keyword: unlocks the Raise Shield reaction (negates a front attack).",
  "Field": "Upgrade nature: always on, no conditions. Never a trap pick.",
  "Tuned": "Upgrade nature: conditional; beats Field when its trigger is set up.",
  "Prototype": "Upgrade nature: a new tracked mechanic with a big payoff; may carry a downside. Max one per rig.",
  "keyword": "A weapon perk with a special rule (Raking Fire, Rend, Precision...). Hover one to read it.",
