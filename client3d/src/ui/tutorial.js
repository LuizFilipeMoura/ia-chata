...
export const LESSONS = [
  ...
  { id: "arcs", icon: "arc", title: "Arcs and flanking", blurb: "Face your target, then hit it where it's soft.",
    steps: [
      ...
      { title: "Walk around and turn", allow: { select: true, acts: ["move", "sprint"] }, text: "Move up past the dummy's shoulder (north-east, beside it) so you're off its nose, then turn to face it before you confirm. One Move gets you there; a move can turn up to 90°.", highlight: '[data-act="move"], [data-act="sprint"]', done: (m, ev) => ev.moved },
      { title: "Hit it where it's soft", allow: { select: true, acts: ["fire", "move", "sprint"] }, text: "Now Attack. If the dummy isn't offered as a target, it's still outside your wedge: move again. A side or rear bonus in the log means you nailed it.", highlight: '[data-act="fire"]', done: (m) => myAttack(m, (r) => arcOf(r) !== "front"), skipAfterRounds: 2 },
