...
function cheatSheet() {
  modal({
    ...
    body: el("div", { class: "cheat" },
      ...
      el("p", {}, el("b", {}, "Grit: "), "a side 2+ VP behind gets a Grit token each round: a free Improved reaction (Brace −3 Pen, dodges on 3+, counters +2 Pen), or an upgrade to one already placed."),
