...
const PILOTS = {
  "Missile Barrage": {
    name: "Ottilie", lines: {
      ...
      hurt: ["Hey! That's my job!", "Is that MY oil?", "She's more on fire than usual.", "Rude!", "Did {it} just singe me?", "That's the good fuel tank, you animal!"],
      critical: ["Everything's on fire and for once it isn't me!", "Fuel line's gone, fuel line's GONE!"],
      heat: ["Is it supposed to smell like that?", "Pilot light's always on.", "Hot. Hot. Hot.", "Toastier in here…", "Old girl's sweating kerosene.", "I've got hair left, right?"],
      eject: ["Ejecting! Somebody call the adjuster!", "Tell them it was the wiring!"],
      move: ["Burn for mama.", "Mind the fuel line, mind the fuel line…", "Keep the rack pointed away from me, darling.", "Off we pop.", "Eyes on {it}!", "Going wide! Try to keep up!", "Scouting ahead with matches."],
      re: ["Some of us are on fire here!", "Mm-hm.", "*static*", "Yes, yes, I'm going.", "Can't catch me, can't boss me."],
      re_kill: ["Show-off.", "Ooh, can I set it on fire anyway?", "Nice!"],
      ...
      re_miss: ["Blame the wind.", "I'd have set it on fire."],
    },
  },
  "Harpoon": {
    name: "Jonah", lines: {
      ...
      hurt: ["Leaking like my old ship.", "Taking water.", "Easy, girl…", "Hull's weeping.", "{It} bites.", "Hold together, girl."],
      critical: ["Not yet, girl. Not yet.", "Water to the gunwales. Hold."],
      ...
      move: ["Easy, girl.", "Casting off.", "Steady as she goes.", "Heading in.", "Mind the anchor chain.", "{It}'s off the port side.", "Scouting the shallows.", "Old legs still run."],
      re: ["Aye.", "…", "Seen it before.", "Aye, aye.", "Heard you the first time."],
      re_kill: ["Good catch.", "Nice work.", "That'll feed the village."],
  ...
  "Arc Gun": {
    name: "Nell", lines: {
      ...
      hurt: ["That's gonna need an electrician.", "Sparks!", "Who's paying for that?", "Hey! Live equipment!", "I felt that in my fillings.", "{It} knows exactly where to hit."],
      critical: ["Every light on the board is red.", "Is that the wiring I smell?"],
      heat: ["Why are the coils glowing?", "That's not the good hum.", "Smells like ozone in here.", "Insulation's melting again.", "Twenty years on the lines and never this hot."],
      eject: ["Grounding myself!", "Unplug her!"],
      move: ["Come on, girl.", "Mind the cable.", "Keep the grip dry, keep the grip dry…", "Don't touch anything metal.", "Marking {it}.", "Running the line ahead.", "Fast and mostly quiet."],
      re: ["Copy.", "Somebody's shorting on this channel.", "*click*", "On it.", "Don't wait up."],
      re_kill: ["Lights out, nice.", "Pulled its plug."],
      re_hurt: ["You're sparking.", "Keep your hands off the metal."],
      re_eject: ["Another one off the grid.", "Poor sod."],
  ...
  "Autocannon": {
    name: "Ferdinand", lines: {
      ...
      hurt: ["Please don't dent the company asset.", "Who signs off on this damage?", "Tell me this is covered.", "That's coming out of my pay, isn't it.", "Ow! Ow. Sorry. Ow."],
      critical: ["Tell accounts I tried!", "There goes the whole policy."],
      ...
      move: ["Advancing, per protocol.", "Moving up.", "Proceeding cautiously.", "Roughly on schedule!", "Contact! {It}!", "Scouting as instructed!", "I'll report back with a report!"],
      re: ["Noted!", "Should I be writing this down?", "Copy?", "Yes sir! Right away sir!", "Mostly understood!"],
      re_kill: ["Very… lethal!", "I'll mention you in my report!"],
      re_hurt: ["Is that covered?", "Oh dear. Oh dear oh dear."],
      re_eject: ["Who fills in the form for that?", "Oh no, paperwork."],
      re_miss: ["Totally fine.", "Officially, I didn't see that."],
    },
  },
  "Mini Gun": {
    name: "Marguerite", lines: {
      ...
      heat: ["It's positively tropical in here.", "Someone open a window.", "Glowing barrels are so gauche.", "Fetch me ice and gin."],
      eject: ["The family will sell the name.", "This is beneath me."],
      move: ["Make way.", "Onward, I suppose.", "Don't dawdle.", "Let's not linger.", "Someone must go first.", "{It} is hideous.", "Do try to keep pace."],
      re: ["Must you?", "Truly fascinating.", "…", "I'm not taking orders from a tractor.", "Fine. FINE."],
      re_kill: ["Adequate.", "Someone's trying."],
      re_hurt: ["Do try not to bleed on the gravel.", "Dreadful."],
  ...
  "Double MG": {
    name: "Tommy", lines: {
      ...
      heat: ["Engine's feeling that ball.", "Needs a tea break.", "Engine's steaming like my kettle.", "Somebody check the pressure!"],
      eject: ["Clocking out early!", "I want that in writing!", "Somebody finish the job!"],
      ...
      re_kill: ["Nice one, that's a bonus!", "Down it goes!"],
  ...
  "Rivet Gun": {
    name: "Mags", lines: {
      ...
      hurt: ["Don't you DARE seize on me.", "That's not in the blueprint!", "I can hear her grinding.", "Mind the pistons!", "That's a whole weekend of repairs.", "Rude!", "*grinding noise*"],
      critical: ["Every rivet's screaming.", "I built her better than this!"],
      heat: ["Pressure's at one-forty.", "I can HEAR her grinding.", "The gauges are lying.", "Seals won't take much more."],
      eject: ["I TOLD them about the gasket!", "Someone fix her properly this time!"],
      move: ["Easy on the knees, girl.", "Moving.", "Knees are clicking again.", "Gently, gently.", "{It}'s knees are shot, look at it.", "Out front again.", "Fast AND intact is the hard part."],
      re: ["Sure.", "…", "More noise, wonderful.", "Yeah, yeah.", "Don't touch anything."],
      re_kill: ["Clean work, for once.", "At least somebody's precise."],
      re_hurt: ["I'm not fixing that for free.", "What did you DO?"],
      re_eject: ["That rig was FINE last week.", "Salvage it, please."],
      re_miss: ["I TOLD you to calibrate.", "Tolerances!"],
    },
  },
  "Mortar": {
    name: "Harrow", lines: {
      ...
      hurt: ["Requesting a formal complaint.", "Most irregular.", "Hit taken, noted.", "Counter-battery fire, how tedious.", "Damage report to follow."],
      critical: ["Structural integrity: regrettable.", "Please record that I objected."],
      heat: ["Per the manual: pray.", "Boiler past regulation.", "Most unregulated barrel temperature."],
      eject: ["Cause of ejection: paperwork.", "Abandoning the gun, under protest."],
      move: ["Displacing the battery.", "Relocating the tube.", "Stay in formation.", "Lights, screen the flank. Move.", "Form on me.", "Scouts forward, report contact."],
      re: ["Acknowledged.", "Copy, over.", "Maintain radio discipline.", "Stay in formation.", "That's an order."],
      re_kill: ["Well done.", "Logged."],
      re_hurt: ["Report your status.", "Hold the line.", "Fall back behind me. Now.", "Withdraw, I've got you."],
      re_eject: ["Casualty noted.", "Mark the position."],
      re_miss: ["Adjust and refire.", "Correction required.", "Again, properly."],
    },
  },
  "Siege Maul": {
    name: "Ansel", lines: {
      ...
      re_eject: ["…", "Go with grace.", "Not on my watch."],
      re_miss: ["…"],
    },
  },
  "Sniper Cannon": {
    name: "Vera", lines: {
      ...
      critical: ["They won't have me.", "Hands are steady."],
      heat: ["Hot barrel, higher rates.", "Warm barrel, clean conscience.", "Tolerable."],
      eject: ["Unpaid invoice.", "Send the bill."],
      move: ["Relocating.", "New angle.", "…", "Stay off my line.", "Lights, flush it out."],
      re: ["…", "Irrelevant.", "Stop talking. Start moving."],
      re_kill: ["Sloppy but paid.", "Fine."],
      re_hurt: ["Get to cover.", "Pull back.", "Get out of there."],
      re_eject: ["One less split."],
      re_miss: ["Amateur.", "…", "Get closer."],
    },
  },
  "Crossbow": {
    name: "Dee", lines: {
      ...
      critical: ["She's coming apart!", "Oh no no no no. Stay together."],
      heat: ["I'm glowing, and not the flattering kind.", "Is it hot, or is it me?", "I'm melting, darlings."],
      eject: ["Don't let them see me like this!", "Send a car!"],
      move: ["Swooping in.", "Coming through, darlings.", "Fashionably late, as always.", "Darlings, formation, please.", "Lights in front, I'm not scuffing my finish.", "Find me something to shoot, sweeties."],
      re: ["Oh, darling.", "Gossip later?", "Mm, tell me more.", "Chop chop, darlings.", "Less chatter, more scouting."],
      re_kill: ["Divine!", "Oh, bravo, darling!"],
      re_hurt: ["Oh no, your FINISH.", "Poor thing!", "Get behind me, sweetie.", "Who did that?"],
      re_eject: ["Somebody send them flowers.", "Oh, how dreadful."],
