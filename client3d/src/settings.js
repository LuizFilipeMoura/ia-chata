...
const DEFAULTS = { nameplates: true, barks: true, edgePan: true, volume: 0.5, speed: 1, dangerPreview: true, wires: true, followCam: true, diceTray: true, threat: false, theme: "auto" };
