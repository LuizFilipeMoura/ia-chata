...
export const PLAYER_START_GUIDE = [
  ...
  "over 10 rounds (beacons pay face value every round; every kill scores +1 VP,",
  "+2 more on the Priority Target, +2 more if the killer's side was behind), or win immediately by",
