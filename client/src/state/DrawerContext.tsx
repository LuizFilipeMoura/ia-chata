...
import Drawer, { type DrawerConfig } from "../components/overlays/Drawer";
...
export function DrawerProvider({ children }: { children: ReactNode }) {
  ...
  // Mount without `show`, then add `show` on the next frame (mirrors
  // drawer.js `void scrim.offsetWidth; scrim.classList.add("show")`).
  useEffect(() => {
    if (config && !visible) {
