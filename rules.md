...
- **Kneecapper** (Double MG, Prototype) — this Double MG only ever strikes limbs (Arms or Legs — whatever the hit location resolves to is remapped onto one if it isn't already): Hull and Engine can **never** be damaged by it, on any arc. Against limbs it also bypasses its own Raking Fire front-arc auto-fail, at Raking Fire's side-arc value (+4 STR); side/rear keep their normal Raking Fire bonuses.
