...
**Related, do not touch:** `2026-07-15-str-overflow-design.md`, `2026-07-15-weapon-balance-findings.md`: historical reasoning trail, already SUPERSEDED where relevant.
