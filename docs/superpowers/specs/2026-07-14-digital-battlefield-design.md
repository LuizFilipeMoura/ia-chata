...
clearance now covers the full `deployRadius(field)`. **This applies to physical rooms too**: terrain should not spawn in your staging area on a real table either.
